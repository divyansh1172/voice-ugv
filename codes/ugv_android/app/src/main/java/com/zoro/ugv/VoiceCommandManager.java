...
public class VoiceCommandManager {
    ...
    /** Sends a high-priority "stop" command immediately. */
    public void sendPriorityStop() {
        sendBleCommand("stop");
    }

    /** Sends a manual directional command from the UI. */
    public void manualControl(String command) {
        sendBleCommand(command);
    }

    /** Force-stop an in-progress recording. */
